  ...
  <body>
    ...
    <table border="2">
      <tr>
        ...
        <td><em><h4>Total No. of Heads</h4></em></td>

      </tr>
      <?php

include "agentconnection.php";
$records=mysqli_query($connection,"SELECT * from agent_details");
while($data=mysqli_fetch_array($records))
{
  ...
  <tr>
    ...
    <td><em><?php echo $data['heads']; ?></em></td>
